    ...
    public override void ProcessData(GameObject senderTile, Vector2 tileIndexForDebugging)
    {
        ...
        switch (_physicalType)
        {
            ...
            case PhysicalType.Agriculture:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0f, 0.05f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.10f, 0.90f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0f, 0.1f);
                break;
            case PhysicalType.Commercial:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0.8f, 0.95f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.20f, 0.5f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0f, 0.1f);
                break;
            ...
            case PhysicalType.EstateResidential:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0f, 0.1f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.20f, 0.5f);
            ...
            case PhysicalType.Forest:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0f, 0.05f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0f, 0.1f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0f, 0.2f);
                break;
            case PhysicalType.GolfCourse:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0f, 0.2f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.6f, 0.9f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0.1f, 0.3f);
                break;
            case PhysicalType.HighDensity:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0.7f, 0.8f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.6f, 0.9f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0.7f, 1f);
                break;
            case PhysicalType.Highway:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = 1f;
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.9f, 1f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0f, 0.2f);
                break;
            case PhysicalType.Industrial:
                ...
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.9f, 1f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0.4f, 0.8f);
                break;
            case PhysicalType.Institutional:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0.5f, 0.7f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.4f, 1f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0.4f, 0.8f);
                break;
            case PhysicalType.LowMidDensity:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0.5f, 0.7f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.7f, 0.9f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0.8f, 0.9f);
                break;
            case PhysicalType.Meadow:
                ...
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0f, 0.1f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0f, 0.01f);
                break;
            case PhysicalType.NaturalReservoir:
                ...
                senderTile.GetComponent<WaterDepth>().value = Random.Range(1, 10);
                break;
            ...
            case PhysicalType.RecreationCentreSpace:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0.3f, 0.6f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.2f, 0.4f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0.4f, 0.5f);
                break;
            ...
            case PhysicalType.UrbanOpenSpace:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0.1f, 0.4f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0.2f, 0.4f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0.4f, 0.5f);
                break;
            case PhysicalType.Vacant:
                ...
                senderTile.GetComponent<AsphaltDensity>().value = Random.Range(0.85f, 1f);
                senderTile.GetComponent<LandHeight>().value = Mathf.Abs(senderTile.transform.localScale.z);
                senderTile.GetComponent<PollutionLevel>().value = Random.Range(0f, 0.1f);
                senderTile.GetComponent<SewageLevel>().value = Random.Range(0f, 0.1f);
                break;
